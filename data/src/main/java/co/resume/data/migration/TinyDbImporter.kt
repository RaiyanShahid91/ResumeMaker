...
class TinyDbImporter @Inject constructor(
    ...
    private suspend fun importOneResume(tinyDb: TinyDB, legacyId: String) {
        ...
        val resume = ResumeEntity(
            ...
            // TinyDB's legacy resume_template/font_family/color_one/color_two ints predate the
            // current layout/theme system and don't map onto it meaningfully — imported resumes
            // land on the safe ATS default and the user re-picks a template from the new catalog.
            createdAt = createdAt,
            updatedAt = createdAt
        )
